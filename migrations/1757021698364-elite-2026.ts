...
//     await queryRunner.manager.save(TeacherEnrollmentEntity, enrollments);
...
//         (person) =>
//           ({
//             email: person.email ?? person.login_id,
//             password: this.password,
//             name: person.name,
//             isActive: true,
//             emailVerified: true,
...
//               avatar_url: person.avatar_url,
//               time_zone: person.time_zone,
//               track_name: `Track ${person.sis?.schooltracks_title || 'A'}`,
...
//       StudentEntity,
//       users.map((user) => {
//         const person = peoples.find((p) => p.email == user.email);
...
//         course.all_users.find((t) => t.email == student.user.email),
//       );
...
//             : '',
//           teacher_enrollments: teacher_school_enrollment.filter((enrollment) =>
//             teacher_ids.has(
...
//         AND u.email = 'catherine@primeedsolutions.org'
//       `);
//   }
// }
