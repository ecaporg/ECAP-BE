...
export class V161748849484720 implements MigrationInterface {
  name = 'V161748849484720';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "keys" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" integer NOT NULL, "access_token" character varying(512), "session_token" character varying(512), "url" character varying(512), CONSTRAINT "PK_e63d5d51e0192635ab79aa49644" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tenants" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "name" character varying(250), "root_id" bigint, CONSTRAINT "PK_53be67a04681c66b87ee27c9321" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "subjects" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "track_id" integer NOT NULL, "canvas_course_id" character varying(50), "canvas_additional_info" json, "name" character varying(250) NOT NULL, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_89db6913fb005832fbe6133858" ON "student_lp_enrollments_samples_samples" ("studentLpEnrollmentsId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d610c07f8ef1ab6420246c0c75" ON "student_lp_enrollments_samples_samples" ("samplesId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments_samples_samples" ADD CONSTRAINT "FK_d610c07f8ef1ab6420246c0c750" FOREIGN KEY ("samplesId") REFERENCES "samples"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments_samples_samples" DROP CONSTRAINT "FK_d610c07f8ef1ab6420246c0c750"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d610c07f8ef1ab6420246c0c75"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_89db6913fb005832fbe6133858"`,
    );
    await queryRunner.query(
