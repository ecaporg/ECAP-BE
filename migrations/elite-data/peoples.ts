    ...
    const response = await fetch(
      'https://mountainelite.plsis.com/mod.php/admin/registration/studentlist.php?action[getEntityListPageJson]=1',
      {
        headers: {
          ...
          Referer:
            'https://mountainelite.plsis.com/mod.php/admin/registration/studentlist.php?action[Prompt][list]=1&__sp_window_id__=205319750',
...
const mergeStudentsAndSIS = (students: People[], sis: SisStudent[]) => {
  return students.map((student) => {
    const sisStudent = sis.find(
      (s) => s.entity_district_id.toString() === student.sis_user_id,
    );
