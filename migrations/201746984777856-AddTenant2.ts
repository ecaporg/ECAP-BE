...
//         // Create subjects
//         await this.createSubjects(queryRunner, track);
...
//               email: `teacher${i + global_teachers.length}@mlgwc57b.mailosaur.net`,
//               password: this.password,
//               isActive: true,
//               emailVerified: true,
...
//           (_, i) =>
//             ({
//               email: `student${i}@mlgwc57b.mailosaur.net`,
//               password: this.password,
//               firstname: `Student`,
//               lastname: `${i}`,
//               isActive: true,
...
//     let admin = await queryRunner.manager.findOne(UserEntity, {
//       where: { email: 'ecap.colin@gmail.com' },
//     });
//     if (!admin) {
//       admin = await queryRunner.manager.save(UserEntity, {
