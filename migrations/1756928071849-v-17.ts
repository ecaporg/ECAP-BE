...
export class V171756928071849 implements MigrationInterface {
  name = 'V171756928071849';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "courses" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "canvas_id" character varying(50), "name" character varying(250) NOT NULL, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "assignments" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "canvas_id" character varying(50), "course_id" integer NOT NULL, "name" character varying(250) NOT NULL, CONSTRAINT "PK_c54ca359535e0012b04dcbd80ee" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "student_lp_enrollment_assignments" ("student_lp_enrollment_id" integer NOT NULL, "assignment_id" integer NOT NULL, "sample_id" integer, "teacher_school_year_enrollment_id" integer, CONSTRAINT "REL_edf36f799cdeb1a5938c821835" UNIQUE ("sample_id"), CONSTRAINT "PK_79b09591dbfc7b27cc78401885b" PRIMARY KEY ("student_lp_enrollment_id", "assignment_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "samples" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "assignment_title" character varying(250) NOT NULL, "status" "public"."samples_status_enum" NOT NULL, "flag_category" "public"."samples_flag_category_enum", "done_by_id" integer, "subject_id" integer, "grade" character varying, "date" TIMESTAMP, "preview_url" character varying(255), "canvas_submission_id" bigint, CONSTRAINT "PK_d68b5b3bd25a6851b033fb63444" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "subjects" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "track_id" integer NOT NULL, "course_id" integer NOT NULL, CONSTRAINT "PK_1a023685ac2b051b4e557b0b280" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "errors" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "message" text NOT NULL, "tenant_id" integer NOT NULL, CONSTRAINT "PK_f1ab2df89a11cd21f48ff90febb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "teacher_school_year_enrollments" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "school_id" integer NOT NULL, "teacher_id" integer NOT NULL, "academic_year_id" integer NOT NULL, CONSTRAINT "PK_23cb2da4ad8eb829080396fa39e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "student_lp_enrollments" ("updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "teacher_school_year_enrollment_id" integer NOT NULL, "student_id" integer NOT NULL, "student_grade" character varying(40) NOT NULL DEFAULT 'Unknown', "learning_period_id" integer NOT NULL, "completed" boolean NOT NULL DEFAULT false, "percentage" numeric(5,2) NOT NULL DEFAULT '0', "track_id" integer NOT NULL, CONSTRAINT "PK_2ba9006efea9f1fbf4ee7aff87a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollment_assignments" ADD CONSTRAINT "FK_310a7c9edbc451a0e22ae59bf3f" FOREIGN KEY ("teacher_school_year_enrollment_id") REFERENCES "student_lp_enrollments"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subjects" ADD CONSTRAINT "FK_8e3d2ec54e67991ef78c7c1c7ac" FOREIGN KEY ("track_id") REFERENCES "tracks"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "subjects" ADD CONSTRAINT "FK_835122f9fd835b03ef36d817d60" FOREIGN KEY ("course_id") REFERENCES "courses"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" ADD CONSTRAINT "FK_91d55a0d56fb766ae820b9da2db" FOREIGN KEY ("school_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" ADD CONSTRAINT "FK_7e7f633e5e6af67353f728c0b16" FOREIGN KEY ("teacher_id") REFERENCES "teachers"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" ADD CONSTRAINT "FK_196e4e2e1db4568d1c4ebca6624" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments" ADD CONSTRAINT "FK_734806d7265d527e374fadb798e" FOREIGN KEY ("track_id") REFERENCES "tracks"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments" ADD CONSTRAINT "FK_efe973737891798ad29128a807a" FOREIGN KEY ("teacher_school_year_enrollment_id") REFERENCES "teacher_school_year_enrollments"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments" DROP CONSTRAINT "FK_efe973737891798ad29128a807a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments" DROP CONSTRAINT "FK_f7258e4d6f49c0e2fef4fd109ae"`,
    );
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollments" DROP CONSTRAINT "FK_734806d7265d527e374fadb798e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" DROP CONSTRAINT "FK_196e4e2e1db4568d1c4ebca6624"`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" DROP CONSTRAINT "FK_7e7f633e5e6af67353f728c0b16"`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_school_year_enrollments" DROP CONSTRAINT "FK_91d55a0d56fb766ae820b9da2db"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "subjects" DROP CONSTRAINT "FK_835122f9fd835b03ef36d817d60"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student_lp_enrollment_assignments" DROP CONSTRAINT "FK_310a7c9edbc451a0e22ae59bf3f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "teacher_school_year_enrollments"`);
