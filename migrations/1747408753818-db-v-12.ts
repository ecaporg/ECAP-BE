...
// export class DbV121747408753818 implements MigrationInterface {
//   name = 'DbV121747408753818';
...
//     );
//     await queryRunner.query(
//       `ALTER TABLE "samples" ADD CONSTRAINT "FK_5cb55ec97a3a7f5e9f4d24c5e17" FOREIGN KEY ("assignment_period_id") REFERENCES "assignment_periods"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
...
//     );
//     await queryRunner.query(
//       `ALTER TABLE "assignment_periods" ADD CONSTRAINT "FK_6056798a577f93c368d8fa79cbc" FOREIGN KEY ("learning_period_id") REFERENCES "track_learning_periods"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
//       `ALTER TABLE "assignment_periods" ADD CONSTRAINT "FK_69c434efc55aa16aced1e75ce2a" FOREIGN KEY ("course_id") REFERENCES "courses"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
//       `ALTER TABLE "assignment_periods" ADD CONSTRAINT "FK_7e764d50f977738319694dce8bf" FOREIGN KEY ("student_id") REFERENCES "students"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
//       `ALTER TABLE "courses" ADD CONSTRAINT "FK_5d36fddafdb9cabd2df4178160d" FOREIGN KEY ("school_id") REFERENCES "schools"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
//       `ALTER TABLE "courses" ADD CONSTRAINT "FK_fad76a730ee7f68d0a59652fb12" FOREIGN KEY ("teacher_id") REFERENCES "teachers"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
//       `ALTER TABLE "courses" ADD CONSTRAINT "FK_7f099cebb2ad6533754207a949b" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
//     );
//     await queryRunner.query(
