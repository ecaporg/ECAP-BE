...
let KeyService = class KeyService extends core_1.BaseService {
    constructor(keyRepository) {
        super(keyRepository);
        this.keyRepository = keyRepository;
    }
    async refreshSessionToken(tenant, newSessionToken) {
        if (newSessionToken) {
...
exports.KeyService = KeyService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(key_entity_1.KeyEntity)),
