...
let SchoolEntity = class SchoolEntity extends core_1.GenericEntity {
};
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Tenant ID associated with this school' }),
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], SchoolEntity.prototype, "tenant_id", void 0);
__decorate([
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => teacher_enrollment_entity_1.TeacherSchoolYearEnrollmentEntity, (course) => course.school),
    __metadata("design:type", Array)
], SchoolEntity.prototype, "teacher_school_year_enrollments", void 0);
