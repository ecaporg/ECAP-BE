...
_a = FILTER_SCHOOL_KEYS.TENANT_ID, _b = FILTER_SCHOOL_KEYS.DIRECTOR_ID, _c = FILTER_SCHOOL_KEYS.TEACHER_ID;
__decorate([
...
_d = FILTER_ACADEMY_KEYS.TENANT_ID, _e = FILTER_ACADEMY_KEYS.DIRECTOR_ID, _f = FILTER_ACADEMY_KEYS.TEACHER_ID;
__decorate([
    (0, swagger_1.ApiProperty)({
        required: true,
        description: 'Filter by tenant ID',
