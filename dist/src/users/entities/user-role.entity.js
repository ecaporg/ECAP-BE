...
const generic_entity_1 = require("../../core/generic-entity");
const role_entity_1 = require("./role.entity");
const user_entity_1 = require("./user.entity");
let UserRoleEntity = class UserRoleEntity extends generic_entity_1.GenericEntity {
};
...
__decorate([
    ...
    (0, typeorm_2.JoinColumn)({ name: 'user' }),
...
__decorate([
    ...
    (0, typeorm_2.JoinColumn)({ name: 'role' }),
...
exports.UserRoleEntity = UserRoleEntity = __decorate([
    (0, typeorm_1.Index)(['user', 'role'], { unique: true }),
