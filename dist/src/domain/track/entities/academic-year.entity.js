...
let AcademicYearEntity = class AcademicYearEntity extends core_1.IDGenericEntity {
};
...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        type: () => [teacher_enrollment_entity_1.TeacherEnrollmentEntity],
    }),
    (0, typeorm_1.OneToMany)(() => teacher_enrollment_entity_1.TeacherEnrollmentEntity, (teacher_school_year_enrollment) => teacher_school_year_enrollment.academic_year),
    __metadata("design:type", Object)
], AcademicYearEntity.prototype, "teacher_enrollments", void 0);
