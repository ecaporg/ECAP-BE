...
class StaffEntity extends core_1.IDIntGenericEntity {
}
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], StaffEntity.prototype, "tenant_id", void 0);
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => teacher_enrollment_entity_1.TeacherEnrollmentEntity, (teacher_enrollment) => teacher_enrollment.teacher),
    __metadata("design:type", Object)
], TeacherEntity.prototype, "teacher_enrollments", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, typeorm_1.PrimaryColumn)(),
    __metadata("design:type", Number)
], TeacherEntity.prototype, "tenant_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Tenant associated with this admin/superadmin',
        type: () => tenant_entity_1.TenantEntity,
    }),
    (0, typeorm_1.ManyToOne)(() => tenant_entity_1.TenantEntity, (tenant) => tenant.teachers, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'tenant_id' }),
    __metadata("design:type", Object)
], TeacherEntity.prototype, "tenant", void 0);
...
let DirectorEntity = class DirectorEntity extends StaffEntity {
};
...
__decorate([
    ...
    (0, typeorm_1.PrimaryColumn)(),
    __metadata("design:type", Number)
], DirectorEntity.prototype, "tenant_id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Tenant associated with this director',
        type: () => tenant_entity_1.TenantEntity,
    }),
    (0, typeorm_1.ManyToOne)(() => tenant_entity_1.TenantEntity, (tenant) => tenant.directors, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'tenant_id' }),
    __metadata("design:type", Object)
], DirectorEntity.prototype, "tenant", void 0);
__decorate([
