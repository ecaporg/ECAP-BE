...
const course_entity_1 = require("../../subject/entities/course.entity");
const track_entity_1 = require("../../track/entities/track.entity");
const key_entity_1 = require("./key.entity");
let TenantEntity = class TenantEntity extends core_1.IDGenericEntity {
};
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => staff_entity_1.TeacherEntity, (teacher) => teacher.tenant),
    __metadata("design:type", Object)
], TenantEntity.prototype, "teachers", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
...
__decorate([
    ...
    (0, typeorm_1.OneToMany)(() => course_entity_1.CourseEntity, (course) => course.tenant),
    __metadata("design:type", Object)
], TenantEntity.prototype, "courses", void 0);
