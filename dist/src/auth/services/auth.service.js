...
let AuthService = class AuthService {
    ...
    async validateUserById(userId) {
        const user = await this.userService.findOneBy({ id: userId }, { director: { academy: true } });
        if (!user.isActive) {
    ...
    async signUp(user) {
        ...
        await this.authEmailService.sendVerificationLink(createdUser.email, createdUser.name);
