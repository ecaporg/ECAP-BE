...
const FILTER_KEYS = {
  ...
  TEACHER_ID:
    'student_lp_enrollment_assignment.student_lp_enrollment.teacher_enrollments.teacher_id',
  ACADEMY_ID:
    'student_lp_enrollment_assignment.student_lp_enrollment.student.academy_id',
  ACADEMIC_YEAR:
    'student_lp_enrollment_assignment.student_lp_enrollment.teacher_enrollments.academic_year_id',
  STATUS: 'status',
